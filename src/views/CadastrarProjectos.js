      ...
      <Container fluid>
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Cadastro de Projecto</Card.Title>
              </Card.Header>
              <Card.Body>
                <Form>
                  <Row>
                    <Col className="px-1" md="3">
                      <Form.Group>
                        ...
                        <Form.Control
                          placeholder="Introduza o nome do projecto"
                          type="text"
                        ></Form.Control>
                      </Form.Group>
                    </Col>
                    <Col className="pl-1" md="6">
                      <Form.Group>
                        <label>Area do projecto</label>
                        <Form.Control
                          placeholder="Introduza a area de aplicacao do projecto"
                          type="text"
                        ></Form.Control>
                      </Form.Group>
                    </Col>
